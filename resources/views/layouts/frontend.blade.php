...
<html lang="en">
    <head>
        ...
        <meta content="Hasanah  Menjual berbagai macam hijab, jaket, aksesoris dan pakaian islami pria dan wanita" name="description">
        <meta content="{{ $title ?? 'App Toko' }}" name="keywords">
        <meta property="og:locale" content="ID_id"/>
        <meta property="og:type" content="website"/>
        <meta property="og:image" content="{{ asset('assets/img/keranjang.png') }}">
        <!-- Bootstrap CSS -->
        <link rel="shortcut icon" href="{{ asset('assets/img/bamz.png') }}">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md navbar-custom shadow-sm py-3 fixed-top">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}"><b>Bamz Clothes</b></a>
        ...
        <div class="footer">
            <div class="container">
                <div class="row">
                    <div class="col-sm-8">
                        <h4>Butuh Bantuan</h4>
                        <p class="pt-2">08:00 - 21:00 WIB / (Senin - minggu)</p>
