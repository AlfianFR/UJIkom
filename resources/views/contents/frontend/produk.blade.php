    ...
    <div class="row">
        <div class="col-sm-9 mx-auto">
            ...
            <div class="product">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <img src="{{ asset('images/produk/' . $edit->gambar) }}" class="img-fluid w-100 mb-3">
                    </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-8">
                                <a class="btn btn-success btn-md"
                                    href="https://www.youtube.com/watch?v=3ucQG2HQxMc&list=RDMMPmE4R_oCR0Y&index=9{{ $profil_toko->phone }}&text=Halo+Admin+Saya+ingin+membeli+produk+{{url('produk/'.$edit->id)}}" target="_blank" role="button">
                                    <i class="fab fa-whatsapp"></i> Pesan Sekarang
                                </a>
                            </div>
                            <a href="#" class="text-terhubung"><i class=""></i></a>
                        </div>
                    </div>
                </div>
            </div>
